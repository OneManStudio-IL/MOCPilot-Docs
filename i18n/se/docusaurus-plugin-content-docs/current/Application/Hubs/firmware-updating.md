...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_1.png')} alt="Firmwareuppdatering" />

Vyberte **Uppdatera** pro okamžité spuštění aktualizace firmwaru.
...
4. Vyberte **Uppdatera firmware**.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_2.png')} alt="Uppdatera firmware" />

## Během aktualizace firmwaru

Po spuštění aktualizace MOCPilot nahraje firmware do hubu a zobrazí průběh.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_3.png')} alt="Firmwareuppdatering" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_4.png')} alt="Firmwareuppdatering" />

## Dokončení aktualizace

Po úspěšném dokončení aktualizace MOCPilot zobrazí potvrzení.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_5.png')} alt="Firmwareuppdatering" />

Vyberte **OK**. Hub se znovu připojí a karta hubu zobrazí aktualizovanou verzi firmwaru.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_6.png')} alt="Firmwareuppdatering" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_7.png')} alt="Firmwareuppdatering" />
