...
### `Multiplicera` (Nybörjare) {#block_operator_multiply}
...
### `Dividera` (Nybörjare) {#block_operator_divide}
...
### `Matematik (enkel)` (Guru) {#block_operator_math_single}
...
### `Matematik (par)` (Guru) {#block_operator_math_pair}
...
### `Slumptal` (Guru) {#block_operator_pick_random}
...
### `Lika med` (Nybörjare) {#block_operator_equal}

<img src={useBaseUrl('/img/blocks/block_operator_equal.svg')} alt="block_operator_equal.svg" />

Returnerar `true` när två värden är lika.

### `Inte lika med` (Avancerad) {#block_operator_not_equal}
...
### `Större än` (Nybörjare) {#block_operator_greater_than}
...
### `Mindre än` (Nybörjare) {#block_operator_less_than}
...
### `Är mellan` (Avancerad) {#block_operator_is_in_between}
...
### `Och` (Avancerad) {#block_operator_and}
...
### `Eller` (Avancerad) {#block_operator_or}
...
### `Inte` (Avancerad) {#block_operator_not}
...
### `Stränglängd` (Avancerad) {#block_operator_size_of_string}
...
### `Text innehåller` (Guru) {#block_operator_string_contains}
