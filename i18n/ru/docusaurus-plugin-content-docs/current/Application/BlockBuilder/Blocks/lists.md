...
### `Заменить по индексу` (Гуру) {#block_lists_replace_at}
...
### `Удалить` (Продвинутый) {#block_lists_delete}
...
### `Очистить все` (Продвинутый) {#block_lists_clear_all}
...
### `Элемент по индексу` (Продвинутый) {#block_lists_item_at}
...
### `Индекс значения` (Гуру) {#block_lists_index_of_value}
...
### `Содержит значение` (Гуру) {#block_lists_contains_value}
...
### `Размер списка` (Продвинутый) {#block_lists_size_of_value}
