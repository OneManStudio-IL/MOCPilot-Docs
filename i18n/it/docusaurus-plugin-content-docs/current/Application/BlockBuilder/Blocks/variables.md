...
### `Imposta variabile a` (Principiante) {#block_variables_set_to}
...
### `Cambia variabile di` (Avanzato) {#block_variables_change_by}
...
### `Valore variabile` (Principiante) {#block_variables_value}
