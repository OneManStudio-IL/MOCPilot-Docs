...
### `Avvia motore` (Principiante) {#block_hubs_all_motors_port_start_motor}
...
### `Ferma motore` (Principiante) {#block_hubs_all_motors_port_stop_motor}
...
### `Esegui per` (Avanzato) {#block_hubs_all_motors_port_run_for}
...
### `Avvia motore a velocita` (Principiante) {#block_hubs_all_motors_port_start_motor_at_speed}
...
### `Esegui per a velocita` (Avanzato) {#block_hubs_all_motors_port_run_for_at_speed}
...
### `Imposta velocita motore` (Avanzato) {#block_hubs_all_motors_port_set_motor_speed}
...
### `Vai alla posizione` (Avanzato) {#block_hubs_all_motors_port_go_to_position}
...
### `Vai alla posizione relativa` (Principiante) {#block_hubs_all_motors_port_go_to_relative_position}
...
### `BuWizz 3 vai alla posizione relativa` (Principiante) {#block_hubs_buwizz3_motors_port_go_to_relative_position}
...
### `Imposta posizione relativa` (Principiante) {#block_hubs_all_motors_port_set_relative_position}
...
### `Calibra cremagliera dello sterzo` (Principiante) {#block_hubs_all_motors_port_calibrate_steering_rack}
...
### `Imposta comportamento motore all'arresto` (Guru) {#block_hubs_all_motors_port_set_motor_to_at_stop}
...
### `Imposta rilevamento stallo` (Guru) {#block_hubs_all_motors_port_set_motors_stall_detection}
...
### `Imposta accelerazione` (Guru) {#block_hubs_all_motors_port_set_acceleration}
...
### `Imposta decelerazione` (Guru) {#block_hubs_all_motors_port_set_deceleration}
...
### `Posizione` (Principiante) {#block_hubs_all_motors_port_position}
...
### `Posizione relativa` (Principiante) {#block_hubs_all_motors_port_relative_position}
...
### `Velocita` (Principiante) {#block_hubs_all_motors_port_speed}
...
### `Potenza` (Avanzato) {#block_hubs_all_motors_port_power}
...
### `Avvia motori a velocita` (Principiante) {#block_hubs_technicmove_motors_start_motors_at_speed}
...
### `Impulso di potenza` (Principiante) {#block_hubs_technicmove_motors_power_pulse}
...
Invia un comando di impulso di potenza al Technic Move Hub selezionato.

- Disponibile solo per Technic Move Hub.
- Uso tipico: potenziare brevemente o riattivare il sistema di trazione Technic Move prima di continuare con i blocchi successivi.

### `Ferma motori` (Principiante) {#block_hubs_technicmove_motors_stop_motors}
...
### `Freno` (Principiante) {#block_hubs_technicmove_motors_brake}
...
### `Imposta cremagliera dello sterzo a` (Principiante) {#block_hubs_technicmove_motors_set_steering_rack_to}
...
### `Calibra cremagliera dello sterzo` (Principiante) {#block_hubs_technicmove_motors_calibrate_steering_rack}
