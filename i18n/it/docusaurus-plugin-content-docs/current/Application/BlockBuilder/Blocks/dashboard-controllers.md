...
### `Imposta colore controller` (Avanzato) {#block_dashboard_controller_all_set_color}
...
### `Imposta interattività controller` (Avanzato) {#block_dashboard_controller_all_set_interactivity}
...
### `Evento pulsante` (Principiante) {#block_dashboard_controller_button_event}
...
### `Valore pulsante (booleano)` (Principiante) {#block_dashboard_controller_button_value_boolean}
...
### `Evento D-pad` (Principiante) {#block_dashboard_controller_dpad_event}
...
### `Valore D-pad (booleano)` (Principiante) {#block_dashboard_controller_dpad_value_boolean}
...
### `Evento joystick` (Principiante) {#block_dashboard_controller_joystick_event}
...
### `Valore joystick (float)` (Principiante) {#block_dashboard_controller_joystick_value_float}
...
### `Valore joystick (booleano)` (Principiante) {#block_dashboard_controller_joystick_value_boolean}
...
Restituisce se il joystick selezionato è premuto o rilasciato.
...
### `Evento pedali` (Principiante) {#block_dashboard_controller_pedals_event}
...
### `Valore pedali (float)` (Principiante) {#block_dashboard_controller_pedals_value_float}
...
### `Valore pedali (booleano)` (Principiante) {#block_dashboard_controller_pedals_value_boolean}
...
### `Evento slider` (Principiante) {#block_dashboard_controller_slider_event}
...
### `Valore slider (float)` (Principiante) {#block_dashboard_controller_slider_value_float}
...
### `Evento stepper` (Principiante) {#block_dashboard_controller_stepper_event}
...
### `Valore stepper (float)` (Principiante) {#block_dashboard_controller_stepper_value_float}
...
### `Evento volante` (Principiante) {#block_dashboard_controller_steering_wheel_event}
...
### `Valore volante (float)` (Principiante) {#block_dashboard_controller_steering_wheel_value_float}
...
### `Valore volante (booleano)` (Principiante) {#block_dashboard_controller_steeringwheel_value_boolean}
...
### `Evento interruttore` (Principiante) {#block_dashboard_controller_switch_event}
...
### `Valore interruttore (booleano)` (Principiante) {#block_dashboard_controller_switch_value_boolean}
...
### `Mostra monitor` (Principiante) {#block_dashboard_controller_monitor_show}
...
### `Imposta valore monitor` (Principiante) {#block_dashboard_controller_monitor_set_value}
...
### `Imposta valore inclinazione monitor` (Principiante) {#block_dashboard_controller_monitor_tilt_set_value}
