...
### `Sæt controllerfarve` (Avanceret) {#block_dashboard_controller_all_set_color}
...
### `Sæt controller interaktivitet` (Avanceret) {#block_dashboard_controller_all_set_interactivity}
...
### `Knap-hændelse` (Begynder) {#block_dashboard_controller_button_event}
...
### `Knap-værdi (boolean)` (Begynder) {#block_dashboard_controller_button_value_boolean}
...
### `D-pad hændelse` (Begynder) {#block_dashboard_controller_dpad_event}
...
### `D-pad værdi (boolean)` (Begynder) {#block_dashboard_controller_dpad_value_boolean}
...
### `Joystick hændelse` (Begynder) {#block_dashboard_controller_joystick_event}
...
### `Joystick værdi (float)` (Begynder) {#block_dashboard_controller_joystick_value_float}
...
### `Joystick værdi (boolean)` (Begynder) {#block_dashboard_controller_joystick_value_boolean}
...
Returnerer om det valgte joystick er trykket eller sluppet.

- Type: værdi-blok
- Output: `true`/`false`
- Statusindstillinger: `trykket`, `sluppet`

## Pedal blokke

### `Pedal hændelse` (Begynder) {#block_dashboard_controller_pedals_event}
...
### `Pedal værdi (float)` (Begynder) {#block_dashboard_controller_pedals_value_float}
...
### `Pedal værdi (boolean)` (Begynder) {#block_dashboard_controller_pedals_value_boolean}
...
### `Slider hændelse` (Begynder) {#block_dashboard_controller_slider_event}
...
### `Slider værdi (float)` (Begynder) {#block_dashboard_controller_slider_value_float}
...
### `Stepper hændelse` (Begynder) {#block_dashboard_controller_stepper_event}
...
### `Stepper værdi (float)` (Begynder) {#block_dashboard_controller_stepper_value_float}
...
### `Rat hændelse` (Begynder) {#block_dashboard_controller_steering_wheel_event}
...
### `Rat værdi (float)` (Begynder) {#block_dashboard_controller_steering_wheel_value_float}
...
### `Rat værdi (boolean)` (Begynder) {#block_dashboard_controller_steeringwheel_value_boolean}
...
### `Kontakt hændelse` (Begynder) {#block_dashboard_controller_switch_event}
...
### `Kontakt værdi (boolean)` (Begynder) {#block_dashboard_controller_switch_value_boolean}
...
### `Vis på monitor` (Begynder) {#block_dashboard_controller_monitor_show}
...
### `Sæt monitorværdi` (Begynder) {#block_dashboard_controller_monitor_set_value}
...
### `Sæt tilt monitorværdi` (Begynder) {#block_dashboard_controller_monitor_tilt_set_value}
