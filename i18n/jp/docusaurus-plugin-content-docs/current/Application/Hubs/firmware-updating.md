...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_1.png')} alt="ファームウェア更新" />

Vyberte **アップデート** pro okamžité spuštění aktualizace firmwaru.

Pokud nechcete aktualizovat hned, vyberte **キャンセル**. Aktualizaci můžete spustit později z kontextové nabídky hubu.
...
4. Vyberte **ファームウェアをアップデート**.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_2.png')} alt="ファームウェアをアップデート" />

## Během aktualizace firmwaru

Po spuštění aktualizace MOCPilot nahraje firmware do hubu a zobrazí průběh.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_3.png')} alt="ファームウェア更新" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_4.png')} alt="ファームウェア更新" />

## Dokončení aktualizace

Po úspěšném dokončení aktualizace MOCPilot zobrazí potvrzení.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_5.png')} alt="ファームウェア更新" />

Vyberte **OK**. Hub se znovu připojí a karta hubu zobrazí aktualizovanou verzi firmwaru.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_6.png')} alt="ファームウェア更新" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_7.png')} alt="ファームウェア更新" />
