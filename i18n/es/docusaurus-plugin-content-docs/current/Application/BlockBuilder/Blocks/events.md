...
### `Cuando el programa inicia` (Principiante) {#block_event_when_program_started}
...
### `Cuando` (Avanzado) {#block_event_when}
...
### `Cuando el temporizador sea mayor que` (Avanzado) {#block_event_when_timer_greater_than}
...
### `Cuando se recibe mensaje` (Guru) {#block_event_when_message_recieved}
...
### `Enviar mensaje` (Guru) {#block_event_broadcast}
...
### `Enviar mensaje y esperar` (Guru) {#block_event_broadcast_and_wait}
...
### `Botón del hub presionado` (Principiante) {#block_hubs_all_event_button_pressed}
...
### `Conexión del hub cambiada` (Principiante) {#block_hubs_all_event_connection_changed}
...
### `Batería del hub cambiada` (Principiante) {#block_hubs_all_event_battery_changed}
...
### `Acelerómetro del hub cambiado` (Guru) {#block_hubs_all_event_accelerometer_changed}
...
### `Inclinación del hub cambiada` (Principiante) {#block_hubs_all_event_tilt_changed}
...
### `Orientación del hub cambiada` (Principiante) {#block_hubs_all_event_tilt_orientation_changed}
...
### `Evento sensor de color Technic` (Principiante) {#block_hubs_all_event_port_technic_sensor_color}
...
### `Evento sensor de distancia Technic` (Principiante) {#block_hubs_all_event_port_technic_sensor_distance}
...
### `Evento sensor de distancia BOOST` (Principiante) {#block_hubs_all_event_port_boost_sensor_when_distance}
...
### `Evento sensor de color BOOST` (Principiante) {#block_hubs_all_event_port_boost_sensor_color}
