---
id: FirmwareUpdating
title: Actualizarea firmware-ului
---
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_1.png')} alt="Actualizarea firmware-ului" />

Vyberte **Actualizează** pro okamžité spuštění aktualizace firmwaru.

Pokud nechcete aktualizovat hned, vyberte **Anulează**. Aktualizaci můžete spustit později z kontextové nabídky hubu.
...
4. Vyberte **Actualizează firmware-ul**.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_2.png')} alt="Actualizează firmware-ul" />

## Během aktualizace firmwaru

Po spuštění aktualizace MOCPilot nahraje firmware do hubu a zobrazí průběh.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_3.png')} alt="Actualizarea firmware-ului" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_4.png')} alt="Actualizarea firmware-ului" />

## Dokončení aktualizace

Po úspěšném dokončení aktualizace MOCPilot zobrazí potvrzení.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_5.png')} alt="Actualizarea firmware-ului" />

Vyberte **OK**. Hub se znovu připojí a karta hubu zobrazí aktualizovanou verzi firmwaru.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_6.png')} alt="Actualizarea firmware-ului" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_7.png')} alt="Actualizarea firmware-ului" />
