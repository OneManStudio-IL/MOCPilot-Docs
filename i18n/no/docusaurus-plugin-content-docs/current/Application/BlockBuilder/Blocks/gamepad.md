...
### `Når gamepad-knapp er` (Nybegynner) {#block_gamepad_event_when_button_is}
...
### `Når gamepad D-pad er` (Nybegynner) {#block_gamepad_event_when_dpad_is}
...
### `Når gamepad styrespak er` (Nybegynner) {#block_gamepad_event_when_thumbstick_is}
...
### `Gamepad-knappverdi (boolsk)` (Nybegynner) {#block_gamepad_button_value_boolean}
...
### `Gamepad D-pad-knappverdi (boolsk)` (Nybegynner) {#block_gamepad_dpad_button_value_boolean}
...
### `Gamepad styrespakverdi (float)` (Nybegynner) {#block_gamepad_thumbstick_value_float}
...
### `Gamepad trigger-trykkverdi (float)` (Nybegynner) {#block_gamepad_trigger_pressure_value_float}
