...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_1.png')} alt="Mise à jour du firmware" />

Vyberte **Mettre à jour** pro okamžité spuštění aktualizace firmwaru.

Pokud nechcete aktualizovat hned, vyberte **Annuler**. Aktualizaci můžete spustit později z kontextové nabídky hubu.
...
4. Vyberte **Mettre à jour le firmware**.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_2.png')} alt="Mettre à jour le firmware" />

## Během aktualizace firmwaru

Po spuštění aktualizace MOCPilot nahraje firmware do hubu a zobrazí průběh.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_3.png')} alt="Mise à jour du firmware" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_4.png')} alt="Mise à jour du firmware" />

## Dokončení aktualizace

Po úspěšném dokončení aktualizace MOCPilot zobrazí potvrzení.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_5.png')} alt="Mise à jour du firmware" />

Vyberte **OK**. Hub se znovu připojí a karta hubu zobrazí aktualizovanou verzi firmwaru.

<img src={useBaseUrl('/img/hubs/firmware-updating/fu_6.png')} alt="Mise à jour du firmware" />
...
<img src={useBaseUrl('/img/hubs/firmware-updating/fu_7.png')} alt="Mise à jour du firmware" />
